...
while trees_by_client <= MAX_TREES_NUM:
    ...
    for round in range(3):
        ...
        #     line = f'{trees_by_client},{round+1},{threshold},{execution_time},{squared_error1},{pearson_corr1},{squared_error2},{pearson_corr2},{squared_error3},{pearson_corr3},{squared_error4},{pearson_corr4}'
        #     out_file.write(line)
        #     out_file.write('\n')
...
#         server.aggregate_fit([client1.trees, client2.trees, client3.trees, client4.trees], strategy, threshold=threshold)
